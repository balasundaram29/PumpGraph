   ...
   /* public static Shape clone(final Shape shape) {
    ...
    public static boolean equal(final Shape s1, final Shape s2) {
        if (s1 instanceof Line2D && s2 instanceof Line2D) {
            ...
            return  true;//ObjectUtilities.equal(s1, s2);
        }
    }
     ...
     * @return A triangle shape.
     */
    public static Shape createUpVMark(final float s) {
        final GeneralPath p0 = new GeneralPath();
       // p0.moveTo(0.0f, 0.0f);
        p0.moveTo(-s, s/2.0f);
        p0.lineTo(0.0f, 0.0f);
...
/**
     ...
     * @return A triangle shape.
     */
    public static Shape createUpDPTriangle(final float s) {
        final GeneralPath p0 = new GeneralPath();
        p0.moveTo(0.0f, 0.0f);
        p0.lineTo(0, s);
        p0.lineTo(-s, 0);
   ...
   /**
     * Creates a right-angled triangle shape that points downwards for declared DutyPoint marking ,
     * used when DDP is  greater than observed DP
     *
     * @param s  the size factor (equal to half the height of the triangle).
     *
     * @return A triangle shape.
     */
    public static Shape createDownDPTriangle(final float s) {
        final GeneralPath p0 = new GeneralPath();
        p0.moveTo(0.0f, 0.0f);
        p0.lineTo(0, -s);
        p0.lineTo(s, 0);
     ...
     * @return A triangle shape.
     */
    public static Shape createUpVMarkNarrow(final float s) {
       final GeneralPath p0 = new GeneralPath();
       // p0.moveTo(0.0f, 0.0f);
        p0.moveTo(-s/2.0f, s/2.0f);
        p0.lineTo(0.0f, 0.0f);
        p0.lineTo(s/2.0f, s/2.0f);
       // p0.closePath();
        return p0;
    }
    /**
 ...
 /**
     ...
     * @return A triangle shape.
     */
    public static Shape createLMark(final float s) {
        final GeneralPath p0 = new GeneralPath();
        p0.moveTo(-s,0.0f);
        p0.lineTo(0.0f, 0.0f);
        p0.lineTo(0.0, s);
